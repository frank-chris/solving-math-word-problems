...
import copy
import re
from transformers import DistilBertTokenizer, DistilBertModel, BertForMaskedLM, AutoTokenizer
...
def prepare_data(pairs_trained, pairs_tested_or_valed, trim_min_count, generate_nums, copy_nums, tree=False, use_bert=False, auto_transformer=False, bert_pretrain_path='../pretrain/bert-base-chinese'):
    ...
    if use_bert:
        if auto_transformer:
            ...
            bert_tokenizer = DistilBertTokenizer.from_pretrained(bert_pretrain_path)
