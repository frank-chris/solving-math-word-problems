...
from transformers import DistilBertTokenizer, DistilBertModel, BertForMaskedLM, BertConfig, WEIGHTS_NAME, CONFIG_NAME, AutoModelWithLMHead, AutoModel
import os
...
class EncoderBert(nn.Module):
    def __init__(self, hidden_size, auto_transformer=False, bert_pretrain_path='', dropout=0.5):
        ...
        if auto_transformer:
            ...
            self.bert_model = DistilBertModel.from_pretrained(bert_pretrain_path)
        self.hidden_size = hidden_size
        self.dropout = dropout
